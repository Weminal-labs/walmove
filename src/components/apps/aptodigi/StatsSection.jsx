    ...
    <section>
      <div className="stats-container">
        <div className="stat-item">
          ...
          <span className="stat-value">{OtherUtils.clampNumber(maxSupply)}</span>
        </div>
        <div className="stat-item">
          <span className="stat-title">Total Minted</span>
          <span className="stat-value">{OtherUtils.clampNumber(totalMinted)}</span>
        </div>
        <div className="stat-item">
          <span className="stat-title">Unique Holders</span>
          <span className="stat-value">{OtherUtils.clampNumber(uniqueHolders)}</span>
        </div>
      </div>
